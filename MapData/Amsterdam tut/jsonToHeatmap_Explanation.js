...
const POLYGON_FILE = './GEBIED_BUURTCOMBINATIES_EXWATER.json';
//File has geometry.type = Point
const POINT_FILE = './ZONNEPANELEN2017.json';
...
polygons.features.forEach(function(feature) {
  ...
  feature.properties.PROPERTY_NAME = 0;
  points.features.forEach(function(point) {
      feature.properties.PROPERTY_NAME += +point.properties.NAME_OF_QUANTIFIED_PROPERTY;
  });
});
